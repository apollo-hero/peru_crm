...
<div class="pro-dashboard-head">
    <div class="container">
        <a href="#" class="pro-head-link active">Perfil</a>
        <a href="{{ route('provider.documents.index') }}" class="pro-head-link">Documentos</a>
        <a href="{{ route('provider.location.index') }}" class="pro-head-link">Actualizar Ubicación</a>        
        <a href="{{route('provider.wallet.transation')}}" class="pro-head-link">transacción de billetera</a>
        @if(config('constants.card')==1)
            <a href="{{ route('provider.cards') }}" class="pro-head-link">@lang('provider.card.list')</a>
        @endif
        <a href="{{ route('provider.transfer') }}" class="pro-head-link">Transferir</a>
                        ...
                        <form class="profile-form" action="{{route('provider.profile.update')}}" method="POST" enctype="multipart/form-data" role="form">
                            ...
                            <div class="prof-form-sub-sec">
                                ...
                                <div class="row">
                                    <div class="prof-sub-col prof-1 col-xs-12">
                                        <div class="form-group">
                                            <label>@lang('provider.profile.car_image')</label>
                                            <input type="file" class="form-control" name="car">
                                        </div>
                                    </div>
                                </div>
