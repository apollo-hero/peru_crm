            ...
            <div class="full-page-bg-inner">
                <div class="row no-margin">
                    <div class="col-md-6 log-left">
                        ...
                        <h2>{{config('constants.site_title','Tranxit')}} necesita socios como tú.</h2>
                        <p>Conducir con {{config('constants.site_title','Tranxit')}} y ganar mucho dinero como contratista independiente. Reciba un pago semanal solo por ayudar a nuestra comunidad de pasajeros a obtener paseos por la ciudad. Sea su propio jefe y reciba un pago en tarifas por conducir en su propio horario.</p>
                    </div>
