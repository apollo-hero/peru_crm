...
<html lang="en">
<head>
    <!--  <meta HTTP-EQUIV="Refresh" CONTENT="0; URL=https://miappdetaxis.com/oficial/es/index.html">  -->
    <meta charset="utf-8">
    ...
    <div id="wrapper">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <!--<li @if(Request::url() == url('/ride')) class="active" @endif>
                                    <a href="{{url('/ride')}}">Pasajero</a>
                                </li>-->
                                <li @if(Request::url() == url('/drive')) class="active" @endif>
                                    <a href="{{url('/drive')}}">Conductor</a>
                                </li>
                            ...
                            <!--<ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a class="btn-outline" href="{{url('/register')}}">Registrarse como Pasajero</a></li>
                                <li><a class="menu-btn" href="{{url('/provider/register')}}">Registrarse como Conductor</a></li>
                            </ul>-->
                        </div>
                    </div>
                </nav>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2 col-md-offset-1 support">
                 ...
                 <div class="col-xs-12 col-sm-12  col-md-6 sup-txt"><h2>Soporte Técnico?     Llámanos</h2>
                     <div class="call-num">
<h3 class=""><a href="tel:{{ config('constants.contact_number', '+51960146506
...
')  }}</a> </h3>
    ...
    <div class="container pad-60"">
        <div class="row center">
            <h2>Obtener la aplicación en</h2>
            <p class="white">(Aplicaciones de Android y iOS para Usuarios y Conductores de forma gratuita)</p><br>
            <div class="">

            <div class="col-md-12">
              <div class="">
                 <div class="col-md-4">
                 <a target="_blank" href="https://apps.apple.com/app/id1527737615">
            <img src="{{asset('asset/img/user-appstore.png')}}">
                                        </a>
                                    </div>
                                    <div class="col-md-4">
               <!--  <a target="_blank" href="{{config('constants.store_link_android_user','#')}}">-->
                    <a target="_blank" href="https://play.google.com/store/apps/details?id=com.tranxitpro.ServiTaxiPasajero&hl=es">
            <img src="{{asset('asset/img/user-playstore.png')}}">
                                        </a>
                                    </div>
                                    <div class="col-md-4">
                                        <a target="_blank" href="https://play.google.com/store/apps/details?id=com.tranxitpro.ServiTaxiConductor&hl=es_PE">
    ...
    <div class="container footer-social content-block pad-60"">
        <div class="row center">
            <h2>Conéctese con las redes sociales</h2>
