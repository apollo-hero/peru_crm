                ...
                <div class="login-box row no-margin">
                   <!-- <div class="col-md-12">
                    ...
                    <form role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div id="first_step">
                            <div class="col-md-4">
                                <input value="+51" type="text" placeholder="+1" id="country_code" name="country_code" />
                            </div> 
                            ...
                            <div class="col-md-12" style="padding-bottom: 10px;">
                                <input type="button" class="log-teal-btn small verify_btn" onclick="smsLogin();" value="Verificar número de teléfono"/>
                            </div>
                        ...
                        <div id="second_step" style="display: none;">
                            ...
                            <div class="col-md-12">
                                <button class="log-teal-btn" type="submit">REGISTRO</button>
                            </div>
                    ...
                    <div class="col-md-12">
                        <p class="helper">Or <a href="{{route('login')}}">Inicia</a> con tu cuenta de usuario.</p>   
                    </div>
