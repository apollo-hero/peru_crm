<div class="site-sidebar">
    <div class="custom-scroll custom-scroll-light">
        <ul class="sidebar-menu">
            ...
            @can('heat-map')
            <li>
                <a href="{{ route('admin.recarga') }}" class="waves-effect waves-light">
                    <span class="s-icon"><i class="ti-map"></i></span>
                    <span class="s-text">RECARGAR CREDITO</span>
                </a>
            </li>
            @endcan
            ...
            @can('heat-map')
            <li>
                <a href="{{ route('admin.debito') }}" class="waves-effect waves-light">
                    <span class="s-icon"><i class="ti-map"></i></span>
                    <span class="s-text">DEBITAR CREDITO</span>
                </a>
            </li>
            @endcan
            ...
            @can('heat-map')
            <li>
                <a href="{{ route('admin.sos') }}" class="waves-effect waves-light">
                    <span class="s-icon"><i class="ti-map"></i></span>
                    <span class="s-text">SOS PAGINA</span>
                </a>
            </li>
            @endcan
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('role-list')<li><a href="{{ route('admin.role.index') }}">@lang('admin.include.role_types')</a>
                    </li>@endcan
                    @can('sub-admin-list')<li><a
                            href="{{ route('admin.sub-admins.index') }}">@lang('admin.include.sub_admins')</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('user-list')<li><a href="{{ route('admin.user.index') }}">@lang('admin.include.list_users')</a>
                    </li>@endcan
                    @can('user-create')<li><a
                            href="{{ route('admin.user.create') }}">@lang('admin.include.add_new_user')</a></li>@endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('provider-list')<li><a
                            href="{{ route('admin.provider.index') }}">@lang('admin.include.list_providers')</a></li>
                    @endcan
                    @can('provider-create')<li><a
                            href="{{ route('admin.provider.create') }}">@lang('admin.include.add_new_provider')</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('fleet-list')<li><a
                            href="{{ route('admin.fleet.index') }}">@lang('admin.include.list_fleets')</a></li>@endcan
                    @can('fleet-create')<li><a
                            href="{{ route('admin.fleet.create') }}">@lang('admin.include.add_new_fleet_owner')</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('dispatcher-list')<li><a
                            href="{{ route('admin.dispatch-manager.index') }}">@lang('admin.include.list_dispatcher')</a>
                    </li>@endcan
                    @can('dispatcher-create')<li><a
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('dispute-manager-list')<li><a
                            href="{{ route('admin.dispute-manager.index') }}">@lang('admin.include.list_dispute_managers')</a>
                    </li>@endcan
                    @can('dispute-manager-create')<li><a
                            href="{{ route('admin.dispute-manager.create') }}">@lang('admin.include.add_new_dispute_manager')</a>
                    </li>@endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="with-sub">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('admin.ride.statement.user') }}">@lang('admin.include.user_statement')</a>
                    </li>
                    <li><a href="{{ route('admin.ride.statement.fleet') }}">@lang('admin.include.fleet_statement')</a>
                    </li>
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('promocodes-list')<li><a
                            href="{{ route('admin.promocode.index') }}">@lang('admin.include.list_promocodes')</a></li>
                    @endcan
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('service-types-list')<li><a
                            href="{{ route('admin.service.index') }}">@lang('admin.include.list_service_types')</a></li>
                    @endcan
                    @can('service-types-create')<li><a
                            href="{{ route('admin.service.create') }}">@lang('admin.include.add_new_service_type')</a>
                    </li>@endcan
                    @can('peak-hour-list')<li><a
                            href="{{ route('admin.peakhour.index') }}">@lang('admin.include.peakhour')</a></li>@endcan
                </ul>
            </li>
            @endcan
            @can('documents-list')
            <li class="with-sub">
                ...
                <ul>
                    @can('documents-list')<li><a
                            href="{{ route('admin.document.index') }}">@lang('admin.include.list_documents')</a></li>
                    @endcan
                    @can('documents-create')<li><a
                            href="{{ route('admin.document.create') }}">@lang('admin.include.add_new_document')</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('notification-list')<li><a
                            href="{{ route('admin.notification.index') }}">@lang('admin.include.list_notifications')</a>
                    </li>@endcan
                    @can('notification-create')<li><a
                            href="{{ route('admin.notification.create') }}">@lang('admin.include.add_new_notification')</a>
                    </li>@endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="with-sub">
                ...
                <ul>
                    @can('cancel-reasons-list')<li><a
                            href="{{ route('admin.reason.index') }}">@lang('admin.include.list_reasons')</a></li>@endcan
                    @can('cancel-reasons-create')<li><a
                            href="{{ route('admin.reason.create') }}">@lang('admin.include.add_new_reason')</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
