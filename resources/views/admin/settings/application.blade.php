				...
				<div class="form-group row">
					...
					<div class="col-xs-9">
						<select class="form-control" id="timezone" name="timezone" autocomplete="off">
							<option value="America/Lima" @if(Config::get('constants.timezone') == 'America/Lima') selected @endif>Select Timezone</option>
							<option value="America/Lima" @if(Config::get('constants.timezone') == 'America/Lima') selected @endif>Perú</option>
						</select>
					</div>
				</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-8">
                                <select name="currency" class="form-control" required>
								    <option @if(config('constants.currency') == "S/.") selected @endif value="S/.">SOLES (S/.)</option>                                    
