...
<div class="container-fluid">
      ...
      <button class="btn" onclick="changeGradient(event)">Cambiar gradiente</button>
      <button class="btn btn-primary" onclick="changeRadius(event)">Cambiar radio</button>
      <button class="btn btn-primary" onclick="changeOpacity(event)">Cambiar opacidad</button>
    </div> <br>
