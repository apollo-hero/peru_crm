            ...
            <div class="box box-block bg-white">
	            ...
	            <form class="form-horizontal" action="{{route('admin.send.push')}}" method="POST" role="form" id="create_push">
	            	...
	            	<div class="form-group row">
						...
						<div class="col-xs-10">
							<select class="form-control" name="send_to" onchange="switch_send(this.value)">
								<option value="ALL">Todos los usuarios y controladores</option>
								<option value="USERS">Todos los usuarios</option>
								<option value="PROVIDERS">Todos los conductores</option>
							</select>
						</div>
					</div>

					<div class="form-group row" id="for_users" style="display: none;">
						<label class="col-xs-2 col-form-label">Condiciones de usuario</label>
						<div class="col-xs-5">
							<select class="form-control" name="user_condition" onchange="switch_user_condition(this.value);">
								<option value="">NONE</option>
								<option value="ACTIVE">que estaban activos para </option>
								<option value="LOCATION"> quienes estan en </option>
								<option value="RIDES">quien más usó nuestro servicio más que </option>
						...
						<div class="col-xs-5" id="user_active" style="display: none;">
							<select class="form-control" name="user_active">
								...
								<option value="MONTH">El mes pasado </option>
							</select>
						</div>

						<div class="col-xs-5" id="user_rides"  style="display: none;">
							<input type="number" class="form-control" name="user_rides" placeholder="Numero de viajes">
						</div>

						<div class="col-xs-5" id="user_amount" style="display: none;">
							<input type="number" class="form-control" name="user_amount" placeholder="Cantidad gastada">
						</div>

						<div class="col-xs-5" id="user_location" style="display: none;">
							<input type="text" class="form-control"  id="search_location" placeholder="Ingrese la ubicación">
					...
					<div class="form-group row" id="for_providers" style="display: none;">
						<label class="col-xs-2 col-form-label">Condiciones del conductor</label>
						<div class="col-xs-5">
							<select class="form-control" name="provider_condition" onchange="switch_provider_condition(this.value);">
								<option value="">NINGUNA</option>
								<option value="ACTIVE">que estaban activos para </option>
								<option value="LOCATION"> quienes estan en </option>
								<option value="RIDES">quien más atendió más de </option>
						...
						<div class="col-xs-5" id="provider_rides"  style="display: none;">
							<input type="number" class="form-control" name="provider_rides" placeholder="Numero de viajes">
						</div>

						<div class="col-xs-5" id="provider_amount" style="display: none;">
							<input type="number" class="form-control" name="provider_amount" placeholder="Cantidad gastada">
						</div>

						<div class="col-xs-5" id="provider_location" style="display: none;">
							<input type="text" class="form-control" id="search_provider_location" placeholder="Ingrese la ubicación">
					...
					<div class="form-group row">
						...
						<div class="col-xs-10">
							<textarea maxlength="200" class="form-control" rows="3" name="message" required id="message" placeholder="Ingrese Mensaje" ></textarea>
...
<script type="text/javascript">
	...
	$('#characterLeftDesc').text('Quedan 100 caracteres');

	$('#message').keyup(function () {
	    var max = 100;
	    var len = $(this).val().length;
	    if (len >= max) {
	        $('#characterLeftDesc').text(' Has alcanzado el limite');
	    } else {
	        var ch = max - len;
	        $('#characterLeftDesc').text(ch + ' caracteres a la izquierda');
	    }
	});
