...
<dt class="col-sm-4">@lang('admin.request.Booking_ID') :</dt>
                        ...
                        <dd class="col-sm-8">{{ $request->tiposervicio }}</dd>
			<dt class="col-sm-4">Hora Creacion:</dt>
                        <dd class="col-sm-8">{{ $request->created_at }}</dd>

                        <dt class="col-sm-4">ACTUALIZAD A HORA:</dt>
                        <dd class="col-sm-8">{{ $request->updated_at }}</dd>

                        <dt class="col-sm-4">PRECIO CENTRAL:</dt>
                        <dd class="col-sm-8">{{ $request->preciocentral }}</dd>

                        <dt class="col-sm-4">DESCUENTO PROMOCION:</dt>
                        <dd class="col-sm-8">{{ $request->descuentopromocion }}</dd>
			...
			<dt class="col-sm-4">Teléfono Cliente:</dt>
                       ...
                       <!--  <dt class="col-sm-4">Provider Admin Commission :</dt>
                        ...
                        <dd class="col-sm-8">{{ $request->cancelled_by }}</dd>
