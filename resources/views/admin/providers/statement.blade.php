					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								...
								<i class="fa fa-caret-up text-success mr-0-5"></i><span>from {{$pagination->total}} Carrera(s).</span>
							</div>
						</div>
					</div>
					@else
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								...
								<h1 class="mb-1">{{currency($revenue[0]->overall)}}</h1>
								<i class="fa fa-caret-up text-success mr-0-5"></i><span>from {{$pagination->total}} Carreras.</span>
							</div>
						</div>
					</div>
					@endif
								            ...
								            <table class="table table-striped table-bordered dataTable" id="table-4">
								                <thead>
								                   <tr>
                                                        ...
                                                        @endif
													    <td>@lang('admin.request.coupon')</td>
													    <td>@lang('admin.request.service')</td>
													</tr>
								                </thead>
								                <tbody>
								                <?php $diff = ['-success','-info','-warning','-danger']; ?>
														@foreach($rides as $index => $ride)
															<tr>
																...
																@endif
																<td>{{ $ride->promocode->promo_description }}</td>
																<td>{{ $ride->service_type->name }}</td>
															</tr>
														@endforeach
