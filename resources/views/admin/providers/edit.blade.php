        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.provider.update', $provider->id )}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    ...
                    <label for="car" class="col-xs-2 col-form-label">@lang('admin.car_image')</label>
                    <div class="col-xs-10">
                    @if(isset($provider->car))
                        <img style="height: 90px; margin-bottom: 15px; border-radius:2em;" src="{{img($provider->car)}}">
                    @endif
                        <input type="file" accept="image/*" name="car" class="dropify form-control-file" id="car" aria-describedby="fileHelp">
                    </div>
                </div>
