            ...
            <div class="col-lg-3 col-md-6 col-xs-12">
                <div class="box box-block bg-white tile tile-1 mb-2">
                    ...
                    <div class="t-content">
                        ...
                        <span class="text-muted font-90">% de Bajas por solicitud cancelada</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-xs-12">
                <div class="box box-block bg-white tile tile-1 mb-2">
                    ...
                    <div class="t-content">
                        ...
                        <i class="fa fa-caret-up text-success mr-0-5"></i><span>de {{$rides->count()}} Carreras</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-xs-12">
                ...
                <div class="box bg-white">
                    ...
                    <table class="table mb-md-0">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">Crédito Administrativo</th>
                                <td class="text-success">{{currency($wallet['admin'])}}</td>
                            </tr>
                            <tr>
                                <th scope="row">Crédito de proveedor</th>
                                @if($wallet['provider_credit'])
                                @php($total=$total-$wallet['provider_credit'][0]['total_credit'])
                                <td class="text-success">{{currency($wallet['provider_credit'][0]['total_credit'])}}
                                </td>
                                @else
                            ...
                            <tr>
                                <th scope="row">Débito de proveedor</th>
                            ...
                            <tr>
                                <th scope="row">Crédito de flota</th>
                            ...
                            <tr>
                                <th scope="row">Débito de flota</th>
                            ...
                            <tr>
                                ...
                                <th scope="row">Importe del impuesto</th>
                    ...
                    <table class="table mb-md-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($ride->provider)
                                <td>{{$ride->provider->first_name}}
                                    {{$ride->provider->last_name .' '.$ride->provider->mobile }}</td>
                                @else
                                <td>**NO ASIGNADO**</td>
                                @endif
                                ...
                                <td>
                                    <span class="text-muted">{{$ride->created_at}} ({{$ride->tiposervicio}})</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{route('admin.statement_user', $ride->user_id)}}">Historial</a>
                                </td>
                            </tr>
