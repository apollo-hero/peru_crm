...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('main/assets/css/toastr.min.css')}}">
...
@if($checkRouteDialog =="true")
    ...
    <script type="text/javascript" src="{{asset('main/assets/js/popper.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('main/assets/js/toastr.min.js')}}"></script>
