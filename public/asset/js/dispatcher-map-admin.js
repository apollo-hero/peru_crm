...
function assignProviderShow(providers, trip) {
    ...
    providers.forEach(function(provider) {
        ...
        var content = "<p>Name : "+provider.first_name+" "+provider.last_name+"</p>"+
                ...
                "<a href='/admin/dispatcher/trips/"+trip.id+'/'+provider.id+"' class='btn btn-success'>Asignar  este Chofer(01)</a>";
...
function worldMapInitialize(argument) {
    ...
    //createRideInitialize();
   /* destination_latitude=0, destination_longitude=0, source_latitude=0, source_longitude=0;
