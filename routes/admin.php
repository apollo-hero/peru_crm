...
Route::get('/recarga','AdminController@recarga')->name('recarga');
Route::get('/debito','AdminController@debito')->name('debito');
Route::post('/recarga','AdminController@billeterarecargar')->name('billeterarecargar');
Route::post('/debito','AdminController@billeteradebitar')->name('billeteradebitar');
Route::get('/sos','AdminController@sos')->name('sos');
...
Route::group(['as' => 'dispatcher.', 'prefix' => 'dispatcher'], function () {
    ...
    Route::get('/user_by_mobile', 'DispatcherController@userByMobile')->name('user_by_mobile');
