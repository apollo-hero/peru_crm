...
Route::group(['middleware' => ['provider.api']], function () {
    ...
    Route::post('/target' , 'ProviderResources\ProfileController@target');
    ...
    Route::group(['prefix' => 'trip'], function () {
        ...
        Route::post('{id}/createProviderWalletRecargas',     'ProviderResources\TripController@createProviderWalletRecargas');
        Route::post('{id}/createProviderWalletRecargasDesdeApp',     'ProviderResources\TripController@createProviderWalletRecargasDesdeApp');
