...
class ProfileController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('car')) {
                Storage::delete($Provider->car);
                $Provider->car = $request->car->store('provider/profile');
            }
    ...
    public function available(Request $request)
    {
        ...
        if($Provider->service) {
            ...
            if($Provider->status == 'approved') //augusto27102020
    ...
    public function target(Request $request)
    {
      ...
      // $to = "2020-09-29 23:59:59";
        try {
            
            $Rides = UserRequests::where('provider_id', Auth::user()->id)
          // $Rides = UserRequests::where('provider_id',$request->id)
